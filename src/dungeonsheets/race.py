...
class HighElf(_Elf):
    ...
    languages = ('Common', 'Elvish',)
    features = _Elf.features + (feats.ElfCantrip, feats.ExtraLanguageRace)
...
class Human(Race):
    ...
    charisma_bonus = 1
    languages = ("Common",)
    features = (feats.ExtraLanguageRace,)
...
class Tabaxi(Race):
    ...
    features = (feats.Darkvision, feats.FelineAgility, feats.ExtraLanguageRace)
