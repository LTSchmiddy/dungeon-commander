...
class DrowMagic(Feature):
    ...
    def __init__(self, owner=None):
        ...
        if owner.level >= 5:
            self.spells_known = self.spells_prepared = (spells.DancingLights, spells.Darkness, spells.FaerieFire)
        elif owner.level >= 3:
            self.spells_known = self.spells_prepared = (spells.DancingLights, spells.Darkness)
        else:
            self.spells_known = self.spells_prepared = (spells.DancingLights,)
